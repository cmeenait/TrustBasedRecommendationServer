...
public class Yelp {
  ...
  public static void main(String[] args) {
    ...
    String consumerKey = "xX60k3hmhSsR2g_ctf5DoQ";
    String consumerSecret = "dK2z3EU6g1IZ9kyEi--bY7qbVf0";
    String token = "mVAUwAZYheP899w9y6uXbVFY_ZH6FB5Y";
    String tokenSecret = "DK3zbTwNjZQTZZzKPNyAs78dwFc";
